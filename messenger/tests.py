...
class ThreadTestCase(TestCase):
    ...
    def test_add_message_to_thread(self):
        self.thread.users.add(self.user1,self.user2)
        message1 = Message.objects.create(user = self.user1, content = "Hola a todos")
        message2 = Message.objects.create(user = self.user2, content = "Hola mundo")
    ...
    def test_add_message_from_user_not_in_thread(self):
        ...
        message1 = Message.objects.create(user = self.user1, content = "Hola a todos")
        message2 = Message.objects.create(user = self.user2, content = "Hola mundo")
        message3 = Message.objects.create(user = self.user3, content = "aaa")
    ...
    def test_find_or_create_thread_with_custom_manager(self):
        ...
        thread2 = Thread.objects.find_or_create(self.user1, self.user3)
